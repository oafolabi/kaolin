...
train_loss = np.load(os.getcwd() + "/final_runs/train_loss_full_transf3.npy")
val_loss = np.load(os.getcwd() + "/final_runs/val_loss_full_transf3.npy")
print(train_loss)
print(train_loss.shape)

train_acc = np.load(os.getcwd() + "/final_runs/train_acc_full_transf3.npy")
val_acc = np.load(os.getcwd() + "/final_runs/val_acc_full_transf3.npy")
print(val_acc)
...
plt.savefig("accuracies_transf3.png")
...
plt.savefig("losses_transf3.png")