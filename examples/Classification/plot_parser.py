...
train_loss = np.load(os.getcwd() + "/inv_trans_runs/train_loss_full_transf2.npy")
val_loss = np.load(os.getcwd() + "/inv_trans_runs/val_loss_full_transf2.npy")
print(train_loss)
print(train_loss.shape)

train_acc = np.load(os.getcwd() + "/inv_trans_runs/train_acc_full_transf2.npy")
val_acc = np.load(os.getcwd() + "/inv_trans_runs/val_acc_full_transf2.npy")
print(val_acc)
...
plt.savefig("accuracies_transf2.png")
...
plt.savefig("losses_transf2.png")